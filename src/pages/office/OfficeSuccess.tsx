              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-600">You'll receive a detailed confirmation email within 15 minutes</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-600">Our team will contact you within 24 hours to schedule delivery</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <Calendar className="w-5 h-5 text-blue-600 mr-3 mt-0.5" />
                  <div className="text-left">
                    <h4 className="font-semibold text-gray-900">First Delivery</h4>
                    <p className="text-gray-600">Your first delivery will be scheduled for next week</p>
                  </div>
                </div>
              </div>
            </CardContent>
